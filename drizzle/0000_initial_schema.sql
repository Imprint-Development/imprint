...
CREATE TABLE "courses" (
	...
	"ignored_git_emails" text[] DEFAULT ARRAY[]::text[] NOT NULL,
	"ignored_github_usernames" text[] DEFAULT ARRAY[]::text[] NOT NULL,
...
CREATE TABLE "students" (
	...
	"git_emails" text[] DEFAULT ARRAY[]::text[] NOT NULL,
...
CREATE TABLE "checkpoints" (
	...
	"enabled_pipelines" text[] DEFAULT ARRAY['contributions']::text[] NOT NULL,
	"created_at" timestamp DEFAULT now()
);
--> statement-breakpoint
...
ALTER TABLE "students" ADD CONSTRAINT "students_group_id_student_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."student_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "checkpoint_logs" ADD CONSTRAINT "checkpoint_logs_checkpoint_id_checkpoints_id_fk" FOREIGN KEY ("checkpoint_id") REFERENCES "public"."checkpoints"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "checkpoint_logs" ADD CONSTRAINT "checkpoint_logs_group_id_student_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."student_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "checkpoint_logs" ADD CONSTRAINT "checkpoint_logs_repository_id_repositories_id_fk" FOREIGN KEY ("repository_id") REFERENCES "public"."repositories"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
