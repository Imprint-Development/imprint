...
ALTER TABLE "checkpoint_logs" ADD COLUMN IF NOT EXISTS "repository_id" uuid;--> statement-breakpoint
ALTER TABLE "courses" ADD COLUMN IF NOT EXISTS "ignored_github_usernames" text[] DEFAULT ARRAY[]::text[] NOT NULL;--> statement-breakpoint
ALTER TABLE "students" ADD COLUMN IF NOT EXISTS "github_username" text;--> statement-breakpoint
