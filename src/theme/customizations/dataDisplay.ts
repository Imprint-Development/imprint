        ...
        variants: [
          ...
          },
          {
            ...
            style: {
              ...
              [`& .${chipClasses.label}`]: { color: "hsl(45, 90%, 35%)" },
              ...theme.applyStyles("dark", {
                borderColor: "hsl(45, 95%, 16%)",
                backgroundColor: "hsl(45, 93%, 12%)",
                [`& .${chipClasses.label}`]: { color: "hsl(45, 90%, 65%)" },
              }),
            },
          },
          {
            ...
            style: {
              ...
              [`& .${chipClasses.label}`]: { color: "hsl(210, 100%, 35%)" },
              ...theme.applyStyles("dark", {
                borderColor: "hsl(210, 100%, 16%)",
                backgroundColor: "hsl(210, 100%, 21%)",
                [`& .${chipClasses.label}`]: { color: "hsl(210, 100%, 80%)" },
              }),
            },
          },
          {
